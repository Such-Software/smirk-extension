// ESM wrapper - uses globals for BigNumber, Common, Slatepack
// These are set by init-esm.ts before this module loads
...
class Consensus {
	...
	// Public
		...
		// Set wallet type (added for ESM support)
		static setWalletType(walletType) {
			Consensus.walletType = walletType;
		}
	...
	// Private
		...
		// Default Wallet type (changed to Grin for Smirk)
